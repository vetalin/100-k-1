...
(function(global, factory) {
   ...
   */ var limitShift = function limitShift(options, deps) {
        var result = dom.limitShift(options);
        return {
            fn: result.fn,
            options: [
                options,
   ...
   */ var autoPlacement = function autoPlacement(options, deps) {
        var result = dom.autoPlacement(options);
        return {
            name: result.name,
            fn: result.fn,
            options: [
